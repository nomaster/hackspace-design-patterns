...
\begin{document}
  ...
  \begin{frame}{Ort}
    \concept{Hackerspace}{
      ...
      \pause
      \textsl{Manchmal auch: \textbf{Makerspace}.}
    }
  \end{frame}
  ...
  {
    \usebackgroundtemplate{\includegraphics[height=\paperheight]{hacker.jpg}}
    \begin{frame}{\boxx{Eine Nähmaschine macht Musik}}
      \photoby{See-Ming
  ...
  \begin{frame}{Befehl}
    \pattern{
      Niemand spült das Geschirr. Der Hackerspace sieht hulle aus. Keinen scheint das zu kümmern.
    }{

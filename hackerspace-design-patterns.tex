...
\begin{document}
  ...
  \begin{itemizeframe}{Warum dieser Vortrag?}
  ...
  \begin{itemizeframe}{Woher geklaut?}
...

  {
    ...
    \begin{itemizeframe}{Aktivitäten\\\small Foto von maltman23 cc by-sa}
      \item Do It Yourself
      \item Workshops
      \item Vorträge
...

  {
    ...
    \begin{itemizeframe}{Infrastruktur\\\small Foto von dreamexplorer cc
    by-nc-sa}
      \item Strom
...

  {
    ...
    \begin{frame}{Noisebridge\\\small Foto von sd cc by-nc-sa}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Küche der Noisebridge\\\small Foto von maltman23 cc by-sa}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Beleuchtung im NCY Resistor\\\small Foto von
    girl\_onthe\_lens cc by-nc-nd}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Treffen in der Noisebridge\\\small Foto von maltman23 cc-by-sa}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Vortrag im Robots and Dinosaurs\\\small Foto von Alegrya cc
    by-nc-sa}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Fahrradwerkstatt im i3 Detroit\\\small Foto von Bradmcmahon cc by-nc}
    \end{frame}
  }
...

  {
    ...
    \begin{frame}{Club-Mate im Hack42\\\small Foto von dvanzuijlekom cc by-sa}
    \end{frame}
  }

  \section{Ausblick}

  \begin{itemizeframe}{Legt los!}
  ...
  \begin{itemizeframe}{Vernetzt euch!}
  ...
  \begin{frame}{Ende}
    \begin{center}
      \includegraphics[width=0.8\textwidth]{hackerspaces-whiteboard.jpg}
    \end{center}
  \end{frame}
